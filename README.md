# 📖 React-app-for-UI <a name="about-project"></a>

 **Rails-app-for-UI**  In this exercise, I will connect previous knowledge with new knowledge and use Webpack with jsbundling-rails gem.
